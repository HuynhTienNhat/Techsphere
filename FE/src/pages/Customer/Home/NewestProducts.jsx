...
import { getTop6NewProducts } from '../../../services/api';
...
export default function NewestProducts() {
    ...
    React.useEffect(() => {
        const fetchProducts = async () => {
            try {
                const data = await getTop6NewProducts();
                setProducts(data);
            } catch (error) {
                console.log(error);
    ...
    return(
        <div className="home-products px-30 mt-15">
            <div className="border-15 border-violet-500 rounded-sm p-5">
                <h1 className='text-orange-500 text-xl mb-5'> <FontAwesomeIcon icon={faStar} className="mr-2" /> Sản phẩm mới nhất</h1>
